import { Gap } from "@/app/components/tw-types";

export type SwitcherProps = {
    children?: React.ReactNode;
    threshold?: "10rem" | "11rem" | "12rem" | "13rem" | "14rem" | "15rem" | "16rem" | "17rem" | "18rem" | "19rem" | "20rem" | "21rem" | "22rem" | "23rem" | "24rem" | "25rem" | "26rem" | "27rem" | "28rem" | "29rem" | "30rem" | "31rem" | "32rem" | "33rem" | "34rem" | "35rem" | "36rem" | "37rem" | "38rem" | "39rem" | "40rem" | "41rem" | "42rem" | "43rem" | "44rem" | "45rem" | "46rem" | "47rem" | "48rem" | "49rem" | "50rem" | "51rem" | "52rem" | "53rem" | "54rem" | "55rem" | "56rem" | "57rem" | "58rem" | "59rem" | "60rem" | "61rem" | "62rem" | "63rem" | "64rem";
    space?: Gap;
...
export function Switcher({ children, threshold = "30rem", space = "gap-1", limit = 4 }: SwitcherProps) {
    const childClasses = `[&>*]:grow`;
    const thresholdClass = thresholdClasses[threshold];
    const limitClass = limitClasses[limit];
    return (
        <div className={`flex flex-wrap ${space} ${childClasses} ${thresholdClass} ${limitClass}`}>
            {children}
        </div>
    );
}
